...
import hr.tvz.miholic.hardwareapp.Security.domain.Authority;
import hr.tvz.miholic.hardwareapp.Security.domain.User;
import hr.tvz.miholic.hardwareapp.Security.user.ApplicationUser;
import hr.tvz.miholic.hardwareapp.Security.user.UserAuthentication;
